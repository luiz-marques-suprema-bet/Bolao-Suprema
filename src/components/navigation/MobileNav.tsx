    ...
    >
      <div className="grid h-14 grid-cols-8">
        ...
        <button
          ...
          className="relative flex min-w-0 flex-col items-center justify-center gap-0.5 py-2.5 text-ink-4 transition-all hover:text-ink active:scale-90 active:opacity-60"
        >
          <span className="grid h-5 w-5 place-items-center rounded-full border border-hairline bg-surface-2 text-[12px] leading-none shadow-sm">
            {isDark ? '☾' : '☀'}
          </span>
          <span className="max-w-full truncate px-0.5 font-mono text-[6.5px] font-bold tracking-eyebrow">
            TEMA
          </span>
        </button>
      </div>
