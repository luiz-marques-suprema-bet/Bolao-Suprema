...
const slides = [
  ...
  },
  {
    ...
    body: 'Placar exato: +10 pts. Resultado + gols do vencedor: +7 pts. Só o resultado: +5 pts. No mata-mata o placar (tempo normal) exato vale +12 e acertar quem passa soma +2. Campeão certo: +25 pts.',
  },
  {
    eyebrow: '03 · BORA',
    stamp: '11 JUN',
