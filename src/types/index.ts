...
export const POINT_RULES: PointRule[] = [
  ...
  // Mata-mata — ESCADA (uma faixa só). Placar só tempo regulamentar. O +2 é bônus por
  // acertar quem passa em caso de empate (prorrogação OU pênaltis); soma no exato (12→14).
