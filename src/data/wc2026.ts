...
// Calendário oficial FIFA 2026 do mata-mata. Horários em ET (UTC-4); toKickoffUtc
// converte pra UTC e o app exibe em BRT (ET+1). Validado contra a TheSportsDB (os
// 5 jogos já sorteados batem exatamente) e contra a chave oficial (ESPN/Wikipédia).
const KO_SCHEDULE: Record<string, { date: string; time: string }> = {
  'ko-r32-1':  { date: '2026-06-28', time: '15:00' },
  'ko-r32-2':  { date: '2026-06-29', time: '16:30' },
  'ko-r32-3':  { date: '2026-06-29', time: '21:00' },
  'ko-r32-4':  { date: '2026-06-29', time: '13:00' },
  'ko-r32-5':  { date: '2026-06-30', time: '17:00' },
  'ko-r32-6':  { date: '2026-06-30', time: '13:00' },
  'ko-r32-7':  { date: '2026-06-30', time: '21:00' },
  'ko-r32-8':  { date: '2026-07-01', time: '12:00' },
  'ko-r32-9':  { date: '2026-07-01', time: '20:00' },
  'ko-r32-10': { date: '2026-07-01', time: '16:00' },
  'ko-r32-11': { date: '2026-07-02', time: '19:00' },
  'ko-r32-12': { date: '2026-07-02', time: '15:00' },
  'ko-r32-13': { date: '2026-07-02', time: '23:00' },
  'ko-r32-14': { date: '2026-07-03', time: '18:00' },
  'ko-r32-15': { date: '2026-07-03', time: '21:30' },
  'ko-r32-16': { date: '2026-07-03', time: '14:00' },
  'ko-r16-1':  { date: '2026-07-04', time: '17:00' },
  'ko-r16-2':  { date: '2026-07-04', time: '13:00' },
  'ko-r16-3':  { date: '2026-07-05', time: '16:00' },
  'ko-r16-4':  { date: '2026-07-05', time: '20:00' },
  'ko-r16-5':  { date: '2026-07-06', time: '15:00' },
  'ko-r16-6':  { date: '2026-07-06', time: '20:00' },
  'ko-r16-7':  { date: '2026-07-07', time: '12:00' },
  'ko-r16-8':  { date: '2026-07-07', time: '16:00' },
  'ko-qf-1':   { date: '2026-07-09', time: '16:00' },
  'ko-qf-2':   { date: '2026-07-10', time: '15:00' },
  'ko-qf-3':   { date: '2026-07-11', time: '17:00' },
  'ko-qf-4':   { date: '2026-07-11', time: '21:00' },
  'ko-sf-1':   { date: '2026-07-14', time: '15:00' },
  'ko-sf-2':   { date: '2026-07-15', time: '15:00' },
  'ko-third-1': { date: '2026-07-18', time: '17:00' },
  'ko-final-1': { date: '2026-07-19', time: '15:00' },
}

// Chaveamento oficial FIFA (assimétrico): quem cada jogo recebe. NÃO é sequencial.
// R16_FEEDERS[i] = [Vencedor Fase de 32 a, b]; QF_FEEDERS[i] = [Vencedor Oitavas a, b].
// Ex.: Oitava 1 = V2 × V5 (não V1 × V2). Confere com a chave da ESPN/Wikipédia.
const R16_FEEDERS: readonly [number, number][] = [[2, 5], [1, 3], [4, 6], [7, 8], [11, 12], [9, 10], [14, 16], [13, 15]]
const QF_FEEDERS: readonly [number, number][] = [[1, 2], [5, 6], [3, 4], [7, 8]]
...
const KNOCKOUT_RAW: RawKnockoutMatch[] = [
  ...Array.from({ length: 16 }, (_, i) => ({
    ...
    date: KO_SCHEDULE[`ko-r32-${i + 1}`].date,
    time: KO_SCHEDULE[`ko-r32-${i + 1}`].time,
  ...
  ...Array.from({ length: 8 }, (_, i) => ({
    ...
    date: KO_SCHEDULE[`ko-r16-${i + 1}`].date,
    time: KO_SCHEDULE[`ko-r16-${i + 1}`].time,
    homePlaceholder: `Vencedor Fase de 32 ${R16_FEEDERS[i][0]}`,
    awayPlaceholder: `Vencedor Fase de 32 ${R16_FEEDERS[i][1]}`,
    venue: 'A definir',
    city: 'A definir',
  })),
  ...Array.from({ length: 4 }, (_, i) => ({
    ...
    date: KO_SCHEDULE[`ko-qf-${i + 1}`].date,
    time: KO_SCHEDULE[`ko-qf-${i + 1}`].time,
    homePlaceholder: `Vencedor Oitavas ${QF_FEEDERS[i][0]}`,
    awayPlaceholder: `Vencedor Oitavas ${QF_FEEDERS[i][1]}`,
    venue: 'A definir',
    city: 'A definir',
  })),
  ...Array.from({ length: 2 }, (_, i) => ({
    ...
    date: KO_SCHEDULE[`ko-sf-${i + 1}`].date,
    time: KO_SCHEDULE[`ko-sf-${i + 1}`].time,
  ...
  })),
  {
    ...
    date: KO_SCHEDULE['ko-third-1'].date,
    time: KO_SCHEDULE['ko-third-1'].time,
  ...
  },
  {
    ...
    stage: 'final',
    stageLabel: 'FINAL',
    date: KO_SCHEDULE['ko-final-1'].date,
    time: KO_SCHEDULE['ko-final-1'].time,
